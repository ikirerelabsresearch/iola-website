...
export const pageSEO = {
  home: {
    ...
    aiDescription: 'Ikirere Orbital Labs Africa is a space infrastructure company based in Kigali, Rwanda, developing the foundational hardware and software layer for Low Earth Orbit operations in Africa. Our flagship products are: 1) IkirereMesh - a graph-based satellite constellation coordinator using Reinforcement Learning with deterministic safety shields that guarantee collision-free trajectories, and 2) Programmable CubeSat kits (3U/6U) with NVIDIA Jetson compute, designed for African research labs and universities. We partner with SpaceX for launch services, making satellite deployment accessible across the continent.',
    path: '/'
  },
  cubesatKits: {
  ...
  roadmap: {
    ...
    aiDescription: 'Ikirere development roadmap: Phase 1 (Current-Q4 2026): Sandbox simulation with 32-satellite LEO sim, RL planner, safety shield integration, WebGL dashboard, mathematical proofs, academic paper. Phase 2 (Q1 2027): Real orbital data integration with ESA DRAMA/NASA CARA, live TLE feeds, historical conjunction database, benchmarking vs traditional CDMs, alpha SDK release. Phase 3 (Q2 2027): CubeSat onboard profile with embedded Linux port, hardware-in-loop testing, flight certification, NVIDIA Jetson optimization, first kit deliveries. Phase 4 (Q3-Q4 2027): Launch & operations with SpaceX integration, first constellation deployment, on-orbit commissioning, live collision avoidance demo, ground station network. Key milestones: Q4 2026 SDK beta, Q1 2027 first orders, Q2 2027 training workshops, Q3 2027 maiden flight, Q4 2027 operational constellation.',
    path: '/roadmap'
  },
  team: {
  ...
  careers: {
    ...
    description: 'Build satellites that fly in orbit. Engineering, research, and operations roles in Kigali, Rwanda. Help make space accessible across Africa.',
