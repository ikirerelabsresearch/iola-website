        ...
        <div className="flex flex-wrap gap-10 items-start justify-between mb-10">
          <div className="flex flex-col gap-3 max-w-70">
            ...
            <p className="text-xs text-[#94a3b8] leading-relaxed">
              Building the full autonomous vertical orbital infrastructure for the next generation of spacecraft, missions, and space economies.
            </p>
          </div>
          ...
          <div className="flex gap-12 flex-wrap">
            ...
            <div>
              ...
              <div className="flex flex-col gap-2">
                ...
                <a href="mailto:research@ikirere.com"
                  className="text-sm text-muted hover:text-navy transition-colors">
